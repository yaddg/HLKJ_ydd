...
//			$("#receiveButImg").css("left",receiveleft+"px");
			...
			//说明框高度
//			var heitxt = 320*htmlHeight/640;
//			$(".proIntroduce").css("height",heitxt+"px"); 

//			var heidown = htmlHeight-60-htmlWidth*0.05;
//			$(".proIntroduceDown").css("top",heidown+"px"); 
			
			
			var heibot = $(".proIntroduceTop").position().top;
			var heiWhole = heibot + 150;
			$("#receiveBox").css("height",heiWhole+"px");
			$(".boxbg").css("height",heiWhole+"px");
		},
