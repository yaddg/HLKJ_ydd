...
var receiveObj = {
	...
	novAwardRecord: function() {
		console.log(hltjDomainUrl + "/activity/randomBroadcast");
		$.ajax({
...
window.onload = function() {
	...
	$(".nwDstjImg03").on("click", function() {
		if(memberId != 'undefined' && memberId != null && memberId != 'null' && memberId.length > 0) {
			window.location.href = "noviceWelfareDstjLossInd.html?memberId="+memberId;
		} else {
			window.location.href = hltjAppObj.appLoginUrl;
		}
	});
