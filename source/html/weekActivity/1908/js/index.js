...
//			$(".indexBut").attr("onclick", "");
		...
		$.ajax({
			...
			success: function(data, status, xhr) {
				...
				receiveObj.comIndexActO = data.baoxiang; //充值宝箱
				receiveObj.comIndexActT = data.shitoujiandaobu; //石头剪刀布
				receiveObj.comIndexActTh = data.tianzongrouzong; //甜粽肉粽
				receiveObj.comIndexActF = data.zhuanpan; //转盘 

				receiveObj.comtimeO = receiveObj.comIndexActO.leavingTime;
				receiveObj.comtimeOstart = receiveObj.comIndexActO.beginTime;
				receiveObj.comtimeOend = receiveObj.comIndexActO.endTime;
				...
				switch(receiveObj.comIndexActO.status) {
					case 2:
						...
						$("#indexButT img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaEnd.png");
						break;
					case 1:
						//$("#indexButT").text("活动未开始");
						$("#indexButT img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaNo.png");
						if(receiveObj.comtimeO <= 36000000) {
					...
					case "":
						...
						//$("#indexButO").text("进入活动");
						$("#indexButT img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaIng.png");
				...
				switch(receiveObj.comIndexActT.status) {
					case "":
						if(receiveObj.comtimeT <= 36000000) {
							$("#RechTimeTh").css("display","block");
							countTime2(2);
						}
						//$("#indexButT").text("进入活动");
						$("#indexButTh img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaIng.png");
						$("#indexButTh").attr("onclick", "receiveObj.indexBut(2)");
						break;
					case 1:
						//$("#indexButTh").text("活动未开始");
						
						$("#indexButTh img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaNo.png");
						if(receiveObj.comtimeT <= 36000000) {
							$("#RechTimeTh").css("display","block");
							countTime2(1);
						}
					...
					case 2:
						//$("#indexButT").text("活动已结束");
						$("#indexButTh img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaEnd.png");
						break;
				};
				//活动3
				switch(receiveObj.comIndexActTh.status) {
					case "":
						if(receiveObj.comtimeTh <= 36000000) {
							$("#RechTimeF").css("display","block");
							countTime3(2);
						}
						//$("#indexButTh").text("点击进入");
						$("#indexButF img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaIng.png");
					...
					case 1:
						...
						//$("#indexButTh").text("活动未开始");
						$("#indexButF img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaNo.png");
						break;
					case 2:
						//$("#indexButTh").text("活动已结束");
						$("#indexButF img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaEnd.png");
						break;
				...
				switch(receiveObj.comIndexActF.status) {
					case 1:
						...
						$("#indexButFi img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaNo.png");
						if(receiveObj.comtimeF <= 36000000) {
					...
					case 2:
						...
						$("#indexButFi img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaEnd.png");
						break;
					case "":
						if(receiveObj.comtimeF <= 36000000) {
							$("#RechTimeFi").css("display","block");
						...
						//$("#indexButF").text("进入活动"); 
						$("#indexButFi img").attr("src","http://qiniuapp.hailangkeji.com/zjtjuneStaIng.png");
	...
	indexBut: function(num) {
		...
		//return;
		if(num == 1) {
			window.location.href = 'juneFestivalFirst.html?memberId=' + memberId;
		} else if(num == 2) {
			window.location.href = 'juneSciStoneSecond.html?memberId=' + memberId;
		} else if(num == 3) {
			window.location.href = 'juneDragBoatFesHolidayThird.html?memberId=' + memberId;
		} else if(num == 4) {
			window.location.href = 'juneFestivalFourth.html?memberId=' + memberId;
		} else if(num == 5) {
			...
			window.location.href =  'zhijian://www.zhijian.com/native?name=login';
		}else{
