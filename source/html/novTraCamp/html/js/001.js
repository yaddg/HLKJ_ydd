...
//	$(".swiper-slide").css("left","0");
	...
	$(".swiper-slide img").css("height","520px");
	$(".swiper-slide img").css("width","91%");
//	var slideHl = $(".swiper-slide").css("left");
//	alert(slideHl)
//	$(".swiper-slide").css("margin","0");
//	$(".swiper-slide").css("padding","0");
//	$(".swiper-slide").css("width","91%");
//	$(".swiper-slide").css("margin-right","4.5%");
}
